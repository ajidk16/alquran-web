...
export const metadata: Metadata = {
  ...
  description:
    "Daftar lengkap 114 surah dalam Al-Quran dengan terjemahan bahasa Indonesia",
};
    ...
    <div className="space-y-8">
      <div className="text-center space-y-4">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Baca Al-Quran online dengan terjemahan bahasa Indonesia, fitur
          bookmark, dan audio murattal
        </p>
      </div>
